...
window.T.de = {
  ...
  featk2:'Entscheidung-zu-Ergebnis-Zyklus',
  ...
  cdtsi:'Ein vierschichtiger kognitiver Digital Twin auf Standard-Hardware — ein Raspberry Pi 5 als Live-Datenquelle speist eine multi-paradigmatische Simulation, die von einem LLM in Echtzeit gesteuert wird.',
  cdts1:'Hardware-Schicht (Pi5) — IMU, Encoder, Batterietelemetrie über MQTT alle 2 Sekunden mit Reconnect-Resilienz',
  cdts2:'Simulationsschicht (AnyLogic) — ein echter Agent mit Pi5-Daten neben 19 synthetischen Klonen, 200 Kundenagenten mit sozialer Nachfrage-Modellierung, System Dynamics für Flottengesundheit',
  cdts3:'Intelligenzschicht (Ollama + Mistral 7B) — strukturierte JSON-Szenarienanfragen mit Begründung und Dringlichkeits-Scoring alle 60 Sekunden',
  cdts4:'Orchestrator (Python + FastAPI) — verteilt Szenarien, verarbeitet Ergebnisse, sendet physische Kommandos an die Pi5-Hardware',
  cdtr:'Voll funktionsfähiges Closed-Loop-System mit 30+ Minuten unbeaufsichtigtem Betrieb. Das LLM identifiziert autonom Engpässe in der simulierten Flotte, startet Szenariotests (Roboterausfall, Nachfragespitzen, beschleunigte Batterieentladung), liest KPI-Deltas und passt physisches Hardwareverhalten an — alles unter 15 Sekunden pro Zyklus. Beweist, dass produktionsreife kognitive Digital Twins auf Standard-Hardware machbar sind, ohne spezialisierte Cloud-Infrastruktur.',
  cdtk1:'Schichten — HW → Sim → LLM → HW',
  ...
  navsi:'Ein eigeninitiierter Proof-of-Concept auf einem physischen Schiffs-Proxy mit dem vollen produktiven AWS-Stack — die Architektur wurde end-to-end validiert, bevor maritime Hardware angeschafft wurde. Dreischichtiges Industrial-IoT-Design nach dem ISA-95-Referenzmodell.',
  navs1:'Edge-Schicht — AWS Greengrass v2 als Schiffs-Betriebssystem mit lokalem MQTT-Broker für Offline-Crew-Betrieb',
  navs2:'Cloud-Schicht — AWS IoT Core mit mTLS-Zertifikaten, Device-Shadow Digital Twin, DynamoDB-Reisehistorie',
  navs3:'Anwendungsschicht — AWS Amplify + Cognito mit drei rollenbasierten Dashboards: Captain, Guest, Engineer',
  navs4:'Flottenskalierung integriert — IoT Fleet Provisioning, OTA über Thing Groups, Multi-Region per Parameter',
  navr:'Voll funktionsfähige End-to-End-Plattform. Captain-Kommandos aus jedem Browser weltweit erreichen das Schiff in unter 500ms via API Gateway → Lambda → IoT Core → Greengrass → Hardware. Offline-Modus identisch: bei Satellitenausfall versorgt der lokale MQTT die Crew ohne Latenz, Telemetrie wird gepuffert und bei Reconnect synchronisiert. Dieselbe Architektur skaliert linear auf 1.000+ Schiffe bei etwa 20€/Monat Messaging-Kosten — Größenordnungen unter traditioneller SCADA-Preisstruktur.',
